...
If you're here because you want to contribute to mirc - thank you! There are many ways in which you can
help this project.

## Testing

This is by far one of the biggest ways you can support the project. Please try out mirc and
...
by [opening a new issue](https://github.com/amugofjava/mirc_podcast_player/issues) -
it's that easy!
...
If you would like to work on a feature that has been requested or fix a bug that has been reported
  ...
  via
  an [issue](https://github.com/amugofjava/mirc_podcast_player/issues)
  or [email](mailto:hello@mircplayer.app).
...
- If your code contains labels and strings, they will need translating. Check out [TRANSLATION.md](TRANSLATION.md) for
  more information on how mirc handles multiple languages.
...
- Squash your commits. If you have made several commits, but they are all part of the same logical
  ...
  or you can reach out to [me](mailto:mirc@amugofjava.me.uk) if you need some help.
