...
If you would like to help test mirc please click the image below to head over to the Play Store,
or Amazon App Store.
...
mirc can search for podcasts via iTunes and PodcastIndex. To use PodcastIndex, first create
an account at [https://podcastindex.org](https://podcastindex.org). This will generate the required
key
and secret. To enable searching with PodcastIndex in mirc, pass the key and secret as runtime
arguments:
...
## Open with mirc links

mirc supports deep linking from websites, allowing you to open a podcast within mirc from a
web url. To open a feed
within mirc, you create a link to the mirc website passing in the URL of the feed you
wish to open. For example: to load a feed in mirc from www.example.com you would use the
following link:

https://mircplayer.app/subscribe?url=www.example.com/myfeed.xml

## Built With

mirc makes use of several amazing packages available on [pub.dev](https://pub.dev). Below is a
...
mirc is released under a BSD-Style License. See the LICENSE file for further details.
