...
import 'package:mirc/entities/search_providers.dart';
...
class SettingsBloc extends Bloc {
  ...
  // feature flag: OPML import/export availability (force disabled)
  // UI should read this stream and hide Import/Export OPML entries when false.
  final BehaviorSubject<bool> _opmlAvailable = BehaviorSubject<bool>.seeded(false);
  ...
  /// Stream that indicates whether OPML import/export UI should be shown.
  /// This is intentionally seeded to false to hide OPML features.
  Stream<bool> get opmlAvailable => _opmlAvailable.stream;
