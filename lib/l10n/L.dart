...
class L {
  ...
  String get no_subscriptions_message {
    return message('no_subscriptions_message') ??
        Intl.message(
          'Tap the Islamfort find your podcast episode',
          name: 'no_subscriptions_message',
          desc: 'Displayed on the Home tab',
          locale: localeName,
        );
  }
  ...
  String get no_downloads_message {
    return message('no_downloads_message') ??
        Intl.message(
          ...
          desc: 'Displayed on the Home tab when the user has no subscriptions',
          locale: localeName,
        );
  }
  ...
  String get consent_message {
    return message('consent_message') ??
        Intl.message(
          'This funding link will take you to an external site where you will be able to directly support the show. Links are provided by the podcast authors and is not controlled by MIRC APP.',
  ...
  String get transcript_why_not_url {
    return message('transcript_why_not_url') ??
        Intl.message(
          'https://mircplayer.app/docs/mirc_transcript_support_en.html',
...
class mircLocalisationsDelegate extends LocalizationsDelegate<L> {
  ...
  @override
  bool shouldReload(mircLocalisationsDelegate old) => false;
}

/// This class can be used by third-parties who wish to override or replace
/// some of the strings built into mirc. This class takes a map
