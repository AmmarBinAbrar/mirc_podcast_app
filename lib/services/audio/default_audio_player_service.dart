...
import 'package:mirc/entities/persistable.dart';
import 'package:mirc/entities/sleep.dart';
...
import 'package:mirc/state/persistent_state.dart';
import 'package:mirc/state/queue_event_state.dart';
import 'package:mirc/state/transcript_state_event.dart';
  ...
  DefaultAudioPlayerService({
    ...
    AudioService.init(
      ...
      config: const AudioServiceConfig(
        ...
        androidNotificationChannelName: 'mirc Podcast Player',
