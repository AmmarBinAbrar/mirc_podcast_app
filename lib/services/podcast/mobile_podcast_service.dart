// Copyright 2019 Ammar Bin Abrar. All rights reserved.
...
import 'package:mirc/entities/chapter.dart';
import 'package:mirc/entities/downloadable.dart';
import 'package:mirc/entities/episode.dart';
import 'package:mirc/entities/funding.dart';
import 'package:mirc/entities/person.dart';
import 'package:mirc/entities/podcast.dart';
import 'package:mirc/entities/transcript.dart';
import 'package:mirc/l10n/messages_all.dart';
...
class MobilePodcastService extends PodcastService {
  ...
  Future<podcast_search.Podcast?> _loadPodcastFeed({required String url}) {
    return _loadPodcastFeedCompute(_FeedComputer(api: api, url: url));
  }
  ...
  static Future<podcast_search.Podcast?> _loadPodcastFeedCompute(_FeedComputer c) async {
    try {
      return await c.api.loadFeed(c.url);
    } catch (e, s) {
      final log = Logger('MobilePodcastService');
      log.severe('Failed to load podcast feed: ${c.url}', e, s);
      // ignore: avoid_print
      print('Caught error in _loadPodcastFeedCompute: $e');
      // ignore: avoid_print
      print(s);
      return null;
    }
