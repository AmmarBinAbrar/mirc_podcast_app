...
import 'package:mirc/ui/podcast/chapter_selector.dart';
import 'package:mirc/ui/podcast/dot_decoration.dart';
import 'package:mirc/ui/podcast/now_playing_floating_player.dart';
import 'package:mirc/ui/podcast/now_playing_options.dart';
import 'package:mirc/ui/podcast/person_avatar.dart';
// ignore: unused_import
import 'package:mirc/ui/podcast/playback_error_listener.dart';
import 'package:mirc/ui/podcast/player_position_controls.dart';
import 'package:mirc/ui/podcast/player_transport_controls.dart';
...
class NowPlayingTabs extends StatelessWidget {
  final Episode episode;
  final Widget Function(BuildContext)? transportBuilder;
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            tabs: [
              if (episode.hasChapters)
                Tab(
                  text: L.of(context)!.chapters_label.toUpperCase(),
                ),
              Tab(
                text: L.of(context)!.episode_label.toUpperCase(),
              ),
              Tab(
                text: L.of(context)!.show_notes_label.toUpperCase(),
              ),
            ],
          ),
        ),
                ...
                child: TabBarView(
                  children: [
                    ...
                    StreamBuilder<Episode?>(
                      stream: Provider.of<AudioBloc>(context).nowPlaying,
                      builder: (context, snapshot) {
...
/// into the app.
///
/// When rendering the controls, mirc will check if a PlayerControlsBuilder
