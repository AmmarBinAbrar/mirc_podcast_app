...
import 'package:mirc/ui/podcast/funding_menu.dart';
import 'package:mirc/ui/podcast/playback_error_listener.dart';
import 'package:mirc/ui/podcast/podcast_context_menu.dart';
import 'package:mirc/ui/podcast/podcast_episode_list.dart';
import 'package:mirc/ui/widgets/action_text.dart';
import 'package:mirc/ui/widgets/delayed_progress_indicator.dart';
import 'package:mirc/ui/widgets/episode_filter_selector.dart';
import 'package:mirc/ui/widgets/episode_sort_selector.dart';
import 'package:mirc/ui/widgets/placeholder_builder.dart';
import 'package:mirc/ui/widgets/platform_back_button.dart';
import 'package:mirc/ui/widgets/platform_progress_indicator.dart';
import 'package:mirc/ui/widgets/podcast_html.dart';
import 'package:mirc/ui/widgets/podcast_image.dart';
import 'package:mirc/ui/widgets/sync_spinner.dart';
                        ...
                        background: ExcludeSemantics(
                            child: StreamBuilder<BlocState<Podcast>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  if (podcast == null || podcast.imageUrl == null) {
                                    return const SizedBox.shrink();
                                  }

                                  return Hero(
                                    key: Key('detailhero${podcast.imageUrl}:${podcast.link}'),
  ...
  Widget build(BuildContext context) {
    ...
    return PodcastBannerImage(
      ...
      errorPlaceholder: placeholderBuilder != null
          ...
          : const Image(image: AssetImage('assets/images/mirc-placeholder-logo.png')),
    );
  }
}
...
class _PodcastTitleState extends State<PodcastTitle> with SingleTickerProviderStateMixin {
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                _buildFollowButton(context, false),
  ...
  /// Follow/unfollow button is hidden in the UI.
  Widget _buildFollowButton(BuildContext context, bool isSubscribed) {
    // Follow/unfollow UI disabled — hidden from the interface.
    return const SizedBox.shrink();
  }
}
