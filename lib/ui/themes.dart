...
ThemeData _buildLightTheme() {
  ...
  return base.copyWith(
      ...
      primary: Color.fromARGB(255, 9, 147, 89),
      secondary: Color.fromARGB(255, 13, 142, 88),
      surface: Color(0xffffffff),
      error: Color(0xffd32f2f),
      onSurface: Color(0xff139c63),
    ),
    bottomAppBarTheme: const BottomAppBarTheme().copyWith(
      color: const Color(0xffffffff),
    ),
    cardTheme: const CardThemeData().copyWith(
      color: const Color.fromARGB(255, 10, 124, 77),
      shadowColor: const Color(0xff139c63),
    ),
    brightness: Brightness.light,
    primaryColor: const Color(0xff139c63),
    primaryColorLight: const Color.fromARGB(255, 38, 189, 126),
    primaryColorDark: const Color.fromARGB(255, 10, 123, 76),
    ...
    buttonTheme: base.buttonTheme.copyWith(
      buttonColor: const Color(0xff139c63),
    ),
    iconTheme: base.iconTheme.copyWith(
      color: const Color(0xff139c63),
    ),
    sliderTheme: const SliderThemeData().copyWith(
      valueIndicatorColor: const Color(0xff139c63),
      trackHeight: 2.0,
...
ThemeData _buildDarkTheme() {
  ...
  return base.copyWith(
    colorScheme: const ColorScheme.dark(
      ...
      secondary: Color.fromARGB(255, 20, 165, 105),
    ...
    primaryColorLight: const Color.fromARGB(255, 20, 204, 128),
    primaryColorDark: const Color.fromARGB(255, 14, 159, 98),
    ...
    // ignore: duplicate_ignore
    // ignore: deprecated_member_use
    indicatorColor: const Color(0xff139c63),
    // ignore: duplicate_ignore
    // ignore: deprecated_member_use
    ...
    snackBarTheme: base.snackBarTheme.copyWith(
      actionTextColor: const Color(0xff139c63),
    ),
    outlinedButtonTheme: OutlinedButtonThemeData(
